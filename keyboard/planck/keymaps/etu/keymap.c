...
[_DVORAK] = {
  ...
  {KC_LCTL, DV_A,    DV_O,    DV_E,    DV_U,    DV_I,    DV_D,    DV_H,    DV_T,    DV_N,    DV_S,    DV_SLSH},
...
[_ADJUST] = {
  ...
  {_______, _______, _______, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  _______, DVORAK,  PLOVER,  _______},
